...
const Publications: React.FC = () => {
      ...
      publications: [
        {
          ...
          description:
            'This paper presents an efficient diagnostic approach for multi-class classification of wheat leaf disease using deep transfer and ensemble learning.',
        ...
        },
        {
          ...
          description:
            'This paper proposes a new diagnostic approach for the detection of wheat leaf disease using deep transfer and ensemble learning based models.',
        ...
        {
          title:
            'A Brief Overview of Deep Learning based Techniques for the Detection of Wheat Leaf Disease',
          description:
            'This paper provides a brief overview of deep learning based techniques for the detection of wheat leaf disease.',
  ...
  const renderPublications = () => {
    return (
      <div className=" flex text-white mt-16 justify-center">
        <div>
          <h1 className=" mb-6 text-5xl font-bold text-transparent bg-clip-text bg-gradient-to-r from-purple-500 to-cyan-100">
            Publications
          </h1>
              ...
              <div key={index} className="mb-8">
                ...
                <div className=" flex flex-col justify-center space-y-4">
                  {project.publications.map((publication, idx) => (
                    <div
                      key={idx}
                      className="button-primary-without-hover rounded-lg shadow-md p-6"
                    >
  ...
  return (
    <div className="container mx-auto px-4 py-8">{renderPublications()}</div>
  );
};
